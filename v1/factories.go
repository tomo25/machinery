...
import (
	...
	amqpbroker "github.com/tomo25/machinery/v1/brokers/amqp"
	eagerbroker "github.com/tomo25/machinery/v1/brokers/eager"
	gcppubsubbroker "github.com/tomo25/machinery/v1/brokers/gcppubsub"
	brokeriface "github.com/tomo25/machinery/v1/brokers/iface"
	redisbroker "github.com/tomo25/machinery/v1/brokers/redis"
	sqsbroker "github.com/tomo25/machinery/v1/brokers/sqs"

	amqpbackend "github.com/tomo25/machinery/v1/backends/amqp"
	dynamobackend "github.com/tomo25/machinery/v1/backends/dynamodb"
	eagerbackend "github.com/tomo25/machinery/v1/backends/eager"
	backendiface "github.com/tomo25/machinery/v1/backends/iface"
	memcachebackend "github.com/tomo25/machinery/v1/backends/memcache"
	mongobackend "github.com/tomo25/machinery/v1/backends/mongo"
	nullbackend "github.com/tomo25/machinery/v1/backends/null"
	redisbackend "github.com/tomo25/machinery/v1/backends/redis"

	eagerlock "github.com/tomo25/machinery/v1/locks/eager"
	lockiface "github.com/tomo25/machinery/v1/locks/iface"
	redislock "github.com/tomo25/machinery/v1/locks/redis"
)
